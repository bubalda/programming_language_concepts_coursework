...
parseError [] = Left "Unexpected end of input. Did you finish your code using semicolons (;)?"
parseError ((Token TokSemiColon (TokenPos l c)):_) = Left $ formatPos l c ++ "Unexpected end of line. Tips: Did you finish your code using semicolons (;)"
parseError ((Token tt (TokenPos l c)):_) = Left $ formatPos l c ++ "Unexpected token `" ++ show tt ++ "`. Tips: Check whether the expression is complete and in the right order."
